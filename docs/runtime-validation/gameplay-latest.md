...
- Result: **PASS**
- Validated commit: `dc4ace851534a352756d839e11aab2b026bf6245`
- GitHub Actions run: `30304680333`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-27T20:58:58.553984+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `3`
- Host instance: `full-game-host-30304680333`
- Client instance: `full-game-client-30304680333`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/d359550c-04a5-4c17-a41f-468f8942c86a/execute/async error raise exceeds remaining stack: None
