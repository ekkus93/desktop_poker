...
- Result: **PASS**
- Validated commit: `e5c8eaffba4f991e08f55afbf18b2904c0a37e3c`
- GitHub Actions run: `30301708057`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-27T20:17:23.121887+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `3`
- Host instance: `full-game-host-30301708057`
- Client instance: `full-game-client-30301708057`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/9c4b40bf-1122-4660-bb77-73e07c89af2a/execute/async error raise exceeds remaining stack: None
