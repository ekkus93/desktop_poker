...
- GitHub Actions run: `30315356932`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-27T23:53:13.906880+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `4`
- Host instance: `full-game-host-30315356932`
- Client instance: `full-game-client-30315356932`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/9936575d-36de-456c-b300-897a416c4c51/execute/async error raise exceeds remaining stack: None
