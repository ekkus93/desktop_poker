...
- Result: **PASS**
- Validated commit: `385d2f2daa470cf328ef702daed6837010a8e46b`
- GitHub Actions run: `30328972399`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-28T04:34:59.571694+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `4`
- Host instance: `full-game-host-30328972399`
- Client instance: `full-game-client-30328972399`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/35372cac-9066-4a2c-8fa7-ff3558f41f6d/execute/async error raise exceeds remaining stack: None
