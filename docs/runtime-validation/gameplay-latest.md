...
- Result: **PASS**
- Validated commit: `a1f308707f79fa87b8440a7726fcab40e304821d`
- GitHub Actions run: `30327045725`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-28T03:54:40.080424+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `4`
- Host instance: `full-game-host-30327045725`
- Client instance: `full-game-client-30327045725`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/c418cae9-8134-476e-8653-b3be6ff65a9b/execute/async error raise exceeds remaining stack: None
