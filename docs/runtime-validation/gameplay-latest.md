...
- Result: **PASS**
- Validated commit: `9fffe6ab1d64f1bf456a5e1c5f18fd30142bc231`
- GitHub Actions run: `30299862965`
- Build outcome: `success`
- Gameplay outcome: `success`
- Recorded at: `2026-07-27T19:52:18.226018+00:00`
- Evidence artifact: `linux-release-full-game-evidence`

## Result summary

- Completed hands: `3`
- Host instance: `full-game-host-30299862965`
- Client instance: `full-game-client-30299862965`
...
- **PASS** — out-of-bounds raise was rejected without advancing state: WebDriver POST /session/58c8d734-127e-42ab-ae00-e39ed9ccbe92/execute/async error raise exceeds remaining stack: None
